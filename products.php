...
<head>
    ...
    <title>Our Products - Toothy Treats</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-3">
                <h2 class="text-3xl font-bold text-pink-600 mb-6">Our Sweet Products</h2>
                <div id="dynamic-products" class="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            </div>

            <!-- Order Section -->
            <div class="bg-white p-4 rounded-lg shadow-lg sticky top-24 h-fit">
                <h2 class="text-xl font-bold text-pink-600 mb-4">Your Order</h2>
                <div id="order-items" class="space-y-2 mb-4 max-h-96 overflow-y-auto">
                    <!-- Order items will be added here -->
                </div>
                <div class="border-t pt-4">
                    <div class="flex justify-between items-center mb-3">
                        <span class="text-base font-semibold">Total:</span>
                        <span id="order-total" class="text-lg font-bold text-pink-600">₱0.00</span>
                    </div>
                    <div class="mb-3">
                        <label for="payment" class="block text-sm text-gray-700 mb-1">Payment Amount:</label>
                        <input type="number" id="payment" class="w-full px-3 py-1.5 border rounded-lg focus:border-pink-500 focus:ring-pink-500" placeholder="₱0.00">
                    </div>
                    <button onclick="processPayment()" class="w-full bg-pink-600 text-white py-2 px-4 rounded-lg hover:bg-pink-700 transition duration-300 text-sm">
                        Process Payment
                    </button>
                </div>
            </div>
    ...
    <div id="cart-modal" class="cart-modal">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-2xl font-bold text-pink-600">Your Cart</h3>
            ...
            <div class="mt-6 pt-6 border-t">
                ...
                <button class="w-full bg-pink-600 text-white py-2 px-4 rounded-lg hover:bg-pink-700 transition duration-300">
                    Checkout
                </button>
            </div>
        </div>
    ...
    <footer class="candy-gradient text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-pink-200 mt-8 pt-8 text-center text-pink-100">
                <p>&copy; 2024 Toothy Treats. All rights reserved.</p>
            </div>
        </div>
    </footer>
